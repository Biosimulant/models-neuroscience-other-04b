...
"""Auto-generated BioModule wrapper for Dynamic dopamine modulation in the basal ganglia: Learning in Parkinson (Frank et al 2004,2005).

Source: modeldb:79488
Original: https://modeldb.science/79488
Standard: other
...
class OtherDynamicDopamineModulationInTheBasalGangliaLearning(biosim.BioModule):
    """BioModule wrapper for: Dynamic dopamine modulation in the basal ganglia: Learning in Parkinson (Frank et al 2004,2005)."""

    def __init__(self, model_path: str = "data/79488.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
DynamicDopamineModulationInTheBasalGanglia79488Model = OtherDynamicDopamineModulationInTheBasalGangliaLearning
