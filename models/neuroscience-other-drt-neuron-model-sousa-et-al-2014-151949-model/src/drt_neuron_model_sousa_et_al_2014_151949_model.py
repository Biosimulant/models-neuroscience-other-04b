...
"""Auto-generated BioModule wrapper for DRt neuron model (Sousa et al., 2014).

Source: modeldb:151949
Original: https://modeldb.science/151949
Standard: other
...
class OtherDrtNeuronModelSousaEtAl2014(biosim.BioModule):
    """Placeholder BioModule wrapper for: DRt neuron model (Sousa et al., 2014).
    ...
    def __init__(self, model_path: str = "data/151949.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
DrtNeuronModelSousaEtAl2014151949Model = OtherDrtNeuronModelSousaEtAl2014
