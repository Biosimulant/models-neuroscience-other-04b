...
"""Auto-generated BioModule wrapper for Detailed passive cable model of Dentate Gyrus Basket Cells (Norenberg et al. 2010).

Source: modeldb:140789
Original: https://modeldb.science/140789
Standard: other
...
class OtherDetailedPassiveCableModelOfDentateGyrusBasketCells(bsim.BioModule):
    """Placeholder BioModule wrapper for: Detailed passive cable model of Dentate Gyrus Basket Cells (Norenberg et al. 2010).
...
DetailedPassiveCableModelOfDentateGyrusBa140789Model = OtherDetailedPassiveCableModelOfDentateGyrusBasketCells
