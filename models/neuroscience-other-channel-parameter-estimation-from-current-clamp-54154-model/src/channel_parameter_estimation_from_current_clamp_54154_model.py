...
"""Auto-generated BioModule wrapper for Channel parameter estimation from current clamp and neuronal properties (Toth, Crunelli 2001).

Source: modeldb:54154
Original: https://modeldb.science/54154
Standard: other
...
class OtherChannelParameterEstimationFromCurrentClampAnd(bsim.BioModule):
    """Placeholder BioModule wrapper for: Channel parameter estimation from current clamp and neuronal properties (Toth, Crunelli 2001).
...
ChannelParameterEstimationFromCurrentClamp54154Model = OtherChannelParameterEstimationFromCurrentClampAnd
