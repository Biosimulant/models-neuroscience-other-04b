...
"""Auto-generated BioModule wrapper for Effect of the initial synaptic state on the probability to induce LTP and LTD (Migliore et al. 2015).

Source: modeldb:157339
Original: https://modeldb.science/157339
Standard: other
...
class OtherEffectOfTheInitialSynapticStateOnTheProbabilityTo(biosim.BioModule):
    """BioModule wrapper for: Effect of the initial synaptic state on the probability to induce LTP and LTD (Migliore et al. 2015)."""

    def __init__(self, model_path: str = "data/157339.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
EffectOfTheInitialSynapticStateOnTheProb157339Model = OtherEffectOfTheInitialSynapticStateOnTheProbabilityTo
