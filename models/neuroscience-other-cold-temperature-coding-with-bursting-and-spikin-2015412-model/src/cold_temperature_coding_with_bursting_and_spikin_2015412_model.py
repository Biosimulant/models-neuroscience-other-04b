...
class OtherColdTemperatureCodingWithBurstingAndSpikingBasedOn(biosim.BioModule):
    """BioModule wrapper for: Cold-Temperature Coding with Bursting and Spiking Based on TRP Channel Dynamics in Drosophila Larva Sensory Neurons (Maksymchuk, N., A. Sakurai, D.N. Cox, and G.S. Cymbalyuk, 2023).""""""
