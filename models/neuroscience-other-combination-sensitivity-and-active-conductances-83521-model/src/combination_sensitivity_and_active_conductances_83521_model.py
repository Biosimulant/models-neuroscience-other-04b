...
"""Auto-generated BioModule wrapper for Combination sensitivity and active conductances (Carlson and Kawasaki 2006).

Source: modeldb:83521
Original: https://modeldb.science/83521
Standard: other
...
class OtherCombinationSensitivityAndActiveConductancesCarlsonAnd(biosim.BioModule):
    """BioModule wrapper for: Combination sensitivity and active conductances (Carlson and Kawasaki 2006)."""

    def __init__(self, model_path: str = "data/83521.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
CombinationSensitivityAndActiveConductances83521Model = OtherCombinationSensitivityAndActiveConductancesCarlsonAnd
