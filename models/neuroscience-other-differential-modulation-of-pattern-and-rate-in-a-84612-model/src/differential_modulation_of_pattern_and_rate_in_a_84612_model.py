...
"""Auto-generated BioModule wrapper for Differential modulation of pattern and rate in a dopamine neuron model (Canavier and Landry 2006).

Source: modeldb:84612
Original: https://modeldb.science/84612
Standard: other
...
class OtherDifferentialModulationOfPatternAndRateInADopamine(bsim.BioModule):
    """Placeholder BioModule wrapper for: Differential modulation of pattern and rate in a dopamine neuron model (Canavier and Landry 2006).
...
DifferentialModulationOfPatternAndRateInA84612Model = OtherDifferentialModulationOfPatternAndRateInADopamine
