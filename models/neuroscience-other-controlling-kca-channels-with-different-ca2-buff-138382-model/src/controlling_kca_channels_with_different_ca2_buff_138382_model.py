...
"""Auto-generated BioModule wrapper for Controlling KCa channels with different Ca2+ buffering models in Purkinje cell (Anwar et al. 2012).

Source: modeldb:138382
Original: https://modeldb.science/138382
Standard: other
...
class OtherControllingKcaChannelsWithDifferentCa2Buffering(bsim.BioModule):
    """Placeholder BioModule wrapper for: Controlling KCa channels with different Ca2+ buffering models in Purkinje cell (Anwar et al. 2012).
...
ControllingKcaChannelsWithDifferentCa2Buff138382Model = OtherControllingKcaChannelsWithDifferentCa2Buffering
