...
"""Auto-generated BioModule wrapper for Computational Surgery (Lytton et al. 2011).

Source: modeldb:140881
Original: https://modeldb.science/140881
Standard: other
...
class OtherComputationalSurgeryLyttonEtAl2011(biosim.BioModule):
    """Placeholder BioModule wrapper for: Computational Surgery (Lytton et al. 2011).
    ...
    def __init__(self, model_path: str = "data/140881.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
ComputationalSurgeryLyttonEtAl2011140881Model = OtherComputationalSurgeryLyttonEtAl2011
