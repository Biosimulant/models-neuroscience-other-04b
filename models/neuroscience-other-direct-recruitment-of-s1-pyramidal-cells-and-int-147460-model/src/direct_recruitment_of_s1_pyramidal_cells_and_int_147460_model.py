...
"""Auto-generated BioModule wrapper for Direct recruitment of S1 pyramidal cells and interneurons via ICMS (Overstreet et al., 2013).

Source: modeldb:147460
Original: https://modeldb.science/147460
Standard: other
...
class OtherDirectRecruitmentOfS1PyramidalCellsAndInterneurons(biosim.BioModule):
    """BioModule wrapper for: Direct recruitment of S1 pyramidal cells and interneurons via ICMS (Overstreet et al., 2013)."""

    def __init__(self, model_path: str = "data/147460.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
DirectRecruitmentOfS1PyramidalCellsAndInt147460Model = OtherDirectRecruitmentOfS1PyramidalCellsAndInterneurons
