...
"""Auto-generated BioModule wrapper for Complex dynamics: reproducing Golgi cell electroresponsiveness (Geminiani et al 2018, 2019ab).

Source: modeldb:262456
Original: https://modeldb.science/262456
Standard: other
...
class OtherComplexDynamicsReproducingGolgiCell(bsim.BioModule):
    """Placeholder BioModule wrapper for: Complex dynamics: reproducing Golgi cell electroresponsiveness (Geminiani et al 2018, 2019ab).
...
ComplexDynamicsReproducingGolgiCellElectror262456Model = OtherComplexDynamicsReproducingGolgiCell
