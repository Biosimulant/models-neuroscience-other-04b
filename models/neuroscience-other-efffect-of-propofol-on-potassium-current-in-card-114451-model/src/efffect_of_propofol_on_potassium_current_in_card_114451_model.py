...
"""Auto-generated BioModule wrapper for Efffect of propofol on potassium current in cardiac H9c2 cells (Liu et al. 2008).

Source: modeldb:114451
Original: https://modeldb.science/114451
Standard: other
...
class OtherEfffectOfPropofolOnPotassiumCurrentInCardiacH9c2(biosim.BioModule):
    """BioModule wrapper for: Efffect of propofol on potassium current in cardiac H9c2 cells (Liu et al. 2008)."""

    def __init__(self, model_path: str = "data/114451.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
EfffectOfPropofolOnPotassiumCurrentInCard114451Model = OtherEfffectOfPropofolOnPotassiumCurrentInCardiacH9c2
