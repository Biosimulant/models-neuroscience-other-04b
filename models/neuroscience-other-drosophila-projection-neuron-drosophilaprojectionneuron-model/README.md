...
**Source**: [opensourcebrain](https://github.com/OpenSourceBrain/Drosophila_Projection_Neuron)
**Standard**: other
...
models:
  - path: ../../models/neuroscience-other-drosophila-projection-neuron-drosophilaprojectionneuron-model
    alias: model
```
