...
"""Auto-generated tests for DrosophilaProjectionNeuronDrosophilaprojectionneuronModel.
...
from src.drosophila_projection_neuron_drosophilaprojectionneuron_model import DrosophilaProjectionNeuronDrosophilaprojectionneuronModel  # noqa: E402
from bsim.signals import BioSignal  # noqa: E402


def test_instantiation() -> None:
    module = DrosophilaProjectionNeuronDrosophilaprojectionneuronModel()
...
def test_advance_produces_outputs() -> None:
    module = DrosophilaProjectionNeuronDrosophilaprojectionneuronModel(min_dt=0.1)
