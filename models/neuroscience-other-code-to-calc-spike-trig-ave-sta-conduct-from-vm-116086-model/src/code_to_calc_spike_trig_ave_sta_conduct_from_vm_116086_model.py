...
"""Auto-generated BioModule wrapper for Code to calc. spike-trig. ave (STA) conduct. from Vm (Pospischil et al. 2007, Rudolph et al. 2007).

Source: modeldb:116086
Original: https://modeldb.science/116086
Standard: other
...
class OtherCodeToCalcSpikeTrigAveStaConductFromVmPospischil(biosim.BioModule):
    """BioModule wrapper for: Code to calc. spike-trig. ave (STA) conduct. from Vm (Pospischil et al. 2007, Rudolph et al. 2007)."""

    def __init__(self, model_path: str = "data/116086.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
CodeToCalcSpikeTrigAveStaConductFromVm116086Model = OtherCodeToCalcSpikeTrigAveStaConductFromVmPospischil
