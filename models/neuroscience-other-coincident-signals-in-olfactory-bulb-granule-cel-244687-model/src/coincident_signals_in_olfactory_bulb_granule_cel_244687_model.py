...
"""Auto-generated BioModule wrapper for Coincident signals in Olfactory Bulb Granule Cell spines (Aghvami et al 2019).

Source: modeldb:244687
Original: https://modeldb.science/244687
Standard: other
...
class OtherCoincidentSignalsInOlfactoryBulbGranuleCellSpines(bsim.BioModule):
    """Placeholder BioModule wrapper for: Coincident signals in Olfactory Bulb Granule Cell spines (Aghvami et al 2019).
...
CoincidentSignalsInOlfactoryBulbGranuleCel244687Model = OtherCoincidentSignalsInOlfactoryBulbGranuleCellSpines
