...
"""Auto-generated BioModule wrapper for Duration-tuned neurons from the inferior colliculus of the big brown bat (Aubie et al. 2009).

Source: modeldb:144509
Original: https://modeldb.science/144509
Standard: other
...
class OtherDurationTunedNeuronsFromTheInferiorColliculusOfThe(bsim.BioModule):
    """Placeholder BioModule wrapper for: Duration-tuned neurons from the inferior colliculus of the big brown bat (Aubie et al. 2009).
...
DurationTunedNeuronsFromTheInferiorCollicu144509Model = OtherDurationTunedNeuronsFromTheInferiorColliculusOfThe
