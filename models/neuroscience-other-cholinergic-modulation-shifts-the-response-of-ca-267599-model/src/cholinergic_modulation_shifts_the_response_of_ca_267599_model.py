...
"""Auto-generated BioModule wrapper for Cholinergic Modulation Shifts the Response of CA1 Pyramidal Cells to Depolarizing Ramps via TRPM4 Channels with Potential Implications for Place Cell Firing (Combe et al., 2023).

Source: modeldb:267599
Original: https://modeldb.science/267599
Standard: other
...
class OtherCholinergicModulationShiftsTheResponseOfCa1Pyramidal(biosim.BioModule):
    """BioModule wrapper for: Cholinergic Modulation Shifts the Response of CA1 Pyramidal Cells to Depolarizing Ramps via TRPM4 Channels with Potential Implications for Place Cell Firing (Combe et al., 2023)."""

    def __init__(self, model_path: str = "data/267599.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
CholinergicModulationShiftsTheResponseOfCa267599Model = OtherCholinergicModulationShiftsTheResponseOfCa1Pyramidal
