#!/usr/bin/env python3
"""Run generated space: neuroscience-basal-ganglia-dopamine-combo-0060."""
...
def main() -> None:
    ...
    print(f"Completed {space.get('title', 'neuroscience-basal-ganglia-dopamine-combo-0060')} duration={duration} tick_dt={tick_dt}")
