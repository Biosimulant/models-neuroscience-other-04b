#!/usr/bin/env python3
"""Run generated space: neuroscience-basal-ganglia-dopamine-combo-0061."""
...
def main() -> None:
    ...
    print(f"Completed {space.get('title', 'neuroscience-basal-ganglia-dopamine-combo-0061')} duration={duration} tick_dt={tick_dt}")
